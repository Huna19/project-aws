...
* Tìm hiểu các khái niệm cơ bản về cloud: EC2, Security Group, hạ tầng toàn cầu AWS.
...
Tuần đầu tiên là tuần "làm quen" — tìm hiểu các khái niệm cơ bản: cloud là gì, lợi ích AWS, hạ tầng toàn cầu, shared responsibility model, EC2, loại instance, giá cả, auto scaling, load balancing. Nhiều khái niệm còn mơ hồ nhưng ít nhất đã có hướng để tiếp tục.
