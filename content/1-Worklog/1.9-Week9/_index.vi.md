...
* Phân tích sự đánh đổi kỹ thuật (**Trade-off**) và chốt phương án thiết kế.
...
| 5   | - Phân tích sự đánh đổi kỹ thuật (**Trade-off**): **EC2 + Auto Scaling** vs **AWS Lambda** <br> - Đánh giá cold start, giới hạn thời gian chạy, chi phí, khả năng kiểm soát                 | 18/06/2026   | 18/06/2026      |                                           |
...
Chỗ mình phân tích lâu nhất là sự **đánh đổi kỹ thuật (Trade-off)** giữa **EC2 + Auto Scaling** và **AWS Lambda**. Lambda nhẹ, tự scale, nhưng cold start và giới hạn thời gian chạy (15 phút) không phù hợp cho hệ thống Flash Sale cần xử lý liên tục, ổn định. Cuối cùng chốt dùng **EC2 kết hợp Auto Scaling** — vừa đảm bảo hiệu năng liên tục, vừa tự động mở rộng khi lượng truy cập tăng đột biến.
