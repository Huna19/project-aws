...
*   **Tầng Web Frontend:** Ứng dụng giao diện tĩnh được lưu trữ trên **Amazon S3** (Static Website Hosting), phân phối toàn cầu thông qua mạng phân phối nội dung **Amazon CloudFront** và bảo vệ an ninh bởi **AWS WAF**.
...
*   **Tầng xử lý giao dịch (Worker Tier):** Cụm máy chủ xử lý chạy dưới dạng **AWS Elastic Beanstalk (Worker Environment)** liên tục lắng nghe (polling) hàng đợi SQS FIFO để thực thi tác vụ ghi nhận đặt vé và cập nhật dữ liệu.
